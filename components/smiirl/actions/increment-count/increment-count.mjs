...
export default {
  ...
  description: "Increment count or add a number to the current value. [See the docs here](https://www.npmjs.com/package/@smiirl/smiirl-library-js). modification 4",
  type: "action",
  version: "0.0.2",
  props: {
    smiirl,
