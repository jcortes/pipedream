...
export default {
  ...
  description: "Increment count or add a number to the current value. [See the docs here](https://www.npmjs.com/package/@smiirl/smiirl-library-js). modification 3",
  type: "action",
  version: "0.0.1",
  props: {
    smiirl,
